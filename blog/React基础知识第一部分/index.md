...
学习地址：[新手指南 ReactJS 视频](https://blog.kentcdodds.com/learn-react-fundamentals-and-advanced-patterns-eac90341c9db)，`以下标题均采用链接+视频时长的方式展示`

## [用原始的 React API 写出 Hello World（3:24）](https://egghead.io/lessons/react-write-hello-world-with-raw-react-apis)
...
## [使用 JSX 和 React（5:48）](https://egghead.io/lessons/react-use-jsx-with-react)
...
## [创建自定义 React 组件（5:15）](https://egghead.io/lessons/react-create-custom-react-components)
...
## [使用 PropTypes 验证自定义 React 组件（3:30）](https://egghead.io/lessons/react-validate-custom-react-component-props-with-proptypes)
