---
title: 浏览器工作原理
date: 2021-7-20 01:30:15
categories:
  - 前端
tags: 前端, 浏览器, 高级前端
path: /browser-working-principle/
---
...
![](res/2021-07-20-01-39-18.png)

值得注意的是，和大多数浏览器不同，Chrome 浏览器的每个标签页都分别对应一个呈现引擎实例。每个标签页都是一个独立的进程。

# 呈现引擎

呈现引擎的作用就是在浏览器的屏幕上显示请求的内容。
...
![图：呈现引擎的基本流程](res/2021-07-20-01-41-38.png)
...
![图：WebKit 主流程](res/2021-07-20-01-43-09.png)

![图：Mozilla 的 Gecko 呈现引擎主流程 ](res/2021-07-20-01-43-20.png)
...
// TODO https://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/#Parsing_general
